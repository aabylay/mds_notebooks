    ...
    for i in range(len(odd_nodes)):
        for j in range(len(odd_nodes)):
            if i == j:
                ...
                odd_connections[i][j] = distance(points[odd_nodes[i]], points[odd_nodes[j]])
